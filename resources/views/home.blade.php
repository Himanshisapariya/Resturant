   ...
   @include('food')
                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                          <li><a href='{{ url('/>breakfast') }}'><img src="assets/images/tab-icon-01.png" alt="">Breakfast</a></li>
                                          <li><a href='{{ url('/>lunch') }}'><img src="assets/images/tab-icon-02.png" alt="">Lunch</a></a></li>
                                          <li><a href='{{ url('/dinner') }}'><img src="assets/images/tab-icon-03.png" alt="">Dinner</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    {{-- *** Cart Start*** --}}
        ...
        <div class="row">
            ...
            <div class="col-lg-3 border-primary p-2 ">
               
                <img src="/foodimage/{{ $food->image }}" alt="" class="img-thumbnail" height="150px" width="150px">
