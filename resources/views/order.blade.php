    ...
    <div class="container">
        ...
        <form action="{{ url('/order') }}" method="post">
            ...
            @enderror
              ...
              <div class="form-group col-md-6">
                <button class="btn btn-success btn-lg center" type="submit">Confirm Order</button>
              </div>
      ...
      {{-- <div class="container p-5" align="center">
        <a href="{{ url('/order') }}">
            <button class="btn btn-success btn-lg center" >Confirm Order</button>
        </a>
      </div> --}}
